...
class SimulationFactory(object):
    ...
    def createSimulationSet(self):
        ...
        for index in freeze_atoms:
            index = int(index)
            print('Before:', index, self.system.getParticleMass(index))
            self.system.setParticleMass(int(index), 0*unit.dalton)
            print('After:', index, self.system.getParticleMass(index))
            print('alch_system Before:', index, self.system.getParticleMass(index))
            self.alch_system.setParticleMass(int(index), 0*unit.dalton)
            print(' alch_system After:', index, self.system.getParticleMass(index))
