...
class SimulationFactory(object):
    ...
    def generateSimulationSet(self):
        ...
        (MD, NCMC, and ALCH) which are required to run BLUES."""
...
class Simulation(object):
    ...
    def acceptRejectNCMC(self, temperature=300, write_move=False, **config):
        ...
        ----------
        temperature : float, default=300
            The temperature for which to select the velocities (Kelvin) for NCMC.
        write_move : bool
            If True, will write the trajectory for every NCMC step.
        """
    ...
    def simulateMD(self, nstepsMD=5000, **config):
        ...
        Parameters
        -----------
        nstepsMD : int, optional, default=5000
            The number of MD steps to use.
        """
    ...
    def acceptRejectMC(self, temperature=300, **config):
        ...
        ----------
        temperature : float, default=300
            The temperature for which to select the velocities (Kelvin) for MD.
        """
        md_state0 = self.current_state['md']['state0']
